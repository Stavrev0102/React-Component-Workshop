...
export default function ShowInfoModal({
    ...
    const [userDetails,setUserDetails] = useState( { adress: {} });
        ...
        <div className="detail-container">
          ...
          <div className="content">
            ...
            <div className="user-details">
              ...
              <p>Created on: <strong>{formatIsoDate(userDetails.createdAt)}</strong></p>
              <p>Modified on: <strong>{formatIsoDate(userDetails.updatedAt)}</strong></p>
            </div>
          </div>
        </div>
      </div>
